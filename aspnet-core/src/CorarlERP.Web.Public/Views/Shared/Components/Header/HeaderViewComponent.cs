...
using CorarlERP.Url;
using CorarlERP.Web.Public.Startup;
using CorarlERP.Web.Session;
using CorarlERP.Sessions.Dto;

namespace CorarlERP.Web.Public.Views.Shared.Components.Header
{
    public class HeaderViewComponent : CorarlERPViewComponent
    {
        ...
        public async Task<IViewComponentResult> InvokeAsync(string currentPageName = "", string cleintId = "", string clientSecret = "")
        {
            var tenancyName = "";
            ...
            var input = new AuthenticationBaseInput { ClientId = cleintId, ClientSecret = clientSecret };
            var headerModel = new HeaderViewModel
            {
                LoginInformations = await _sessionCache.GetCurrentLoginInformationsAsync(input),
