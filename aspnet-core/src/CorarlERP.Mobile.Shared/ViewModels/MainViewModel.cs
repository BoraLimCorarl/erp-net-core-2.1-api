...
using MvvmHelpers;
using CorarlERP.Authorization.Users.Profile;
...
using CorarlERP.Services.Navigation;
...
using CorarlERP.Controls;
using CorarlERP.Dto;
using CorarlERP.Extensions;
using CorarlERP.Localization;
using CorarlERP.UI;
using CorarlERP.UI.Assets;
using CorarlERP.Views;
using DependencyResolver = CorarlERP.Core.Dependency.DependencyResolver;
...
namespace CorarlERP.ViewModels
{
    public class MainViewModel : XamarinViewModel
    {
        ...
        private const string ApplicationName = "CorarlERP";
