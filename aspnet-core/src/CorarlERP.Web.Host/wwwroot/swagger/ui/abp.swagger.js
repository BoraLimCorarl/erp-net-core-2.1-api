...
(function () {
    ...
    function loginUserInternal(tenantId, callback) {
        ...
        if (!clientId) {
            alert('Client Id is required, please try with a valid value !');
            return false;
        }

        var clientSecret = document.getElementById('clientSecret').value;
        if (!clientSecret) {
            alert('Client Secret is required, please try with a valid value !');
            return false;
        }
        ...
        xhr.send("{" + "usernameOrEmailAddress:'" + usernameOrEmailAddress + "'," + "password:'" + password + "'," + "clientId:'" + clientId + "'," + "clientSecret:'" + clientSecret +"'}");
    };
    ...
    abp.swagger.openAuthDialog = function (loginCallback) {
        ...
        createInput(modalUxContent, 'clientId', 'Client Id');
        createInput(modalUxContent, 'clientSecret', 'Client Secret');
