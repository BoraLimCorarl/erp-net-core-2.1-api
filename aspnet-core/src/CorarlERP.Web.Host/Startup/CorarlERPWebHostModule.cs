...
namespace CorarlERP.Web.Startup
{
    ...
    public class CorarlERPWebHostModule : AbpModule
    {
        private readonly IHostingEnvironment _env;
        private readonly IConfigurationRoot _appConfiguration;

        public CorarlERPWebHostModule(
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(CorarlERPWebHostModule).GetAssembly());
        }
