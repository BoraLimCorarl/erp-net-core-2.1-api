        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CarlErpCashFlowTemplateAccounts_CarlErpCashFlowAccountGroup~",
                        column: x => x.AccountGroupId,
                        principalTable: "CarlErpCashFlowAccountGroups",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_CarlErpCashFlowTemplateAccounts_CarlErpChartOfAccounts_Acco~",
                        column: x => x.AccountId,
                        principalTable: "CarlErpChartOfAccounts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_CarlErpCashFlowTemplateAccounts_CarlErpCashFlowCategories_C~",
                        column: x => x.CategoryId,
                        principalTable: "CarlErpCashFlowCategories",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_CarlErpCashFlowTemplateAccounts_CarlErpCashFlowTemplates_Te~",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CarlErpCashFlowTemplateCategories_CarlErpCashFlowCategories~",
                        column: x => x.CategoryId,
                        principalTable: "CarlErpCashFlowCategories",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_CarlErpCashFlowTemplateCategories_CarlErpCashFlowTemplates_~",
                        column: x => x.TemplateId,
                        principalTable: "CarlErpCashFlowTemplates",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
