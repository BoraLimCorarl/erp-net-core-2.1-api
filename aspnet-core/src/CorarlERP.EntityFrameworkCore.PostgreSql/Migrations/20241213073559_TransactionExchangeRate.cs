        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CarlCustomerCreditExchangeRates_CarlErpCustomerCredits_Cust~",
                        column: x => x.CustomerCreditId,
                        principalTable: "CarlErpCustomerCredits",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_CarlCustomerCreditExchangeRates_CarlErpCurrencies_FromCurre~",
                        column: x => x.FromCurrencyId,
                        principalTable: "CarlErpCurrencies",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_CarlCustomerCreditExchangeRates_CarlErpCurrencies_ToCurrenc~",
                        column: x => x.ToCurrencyId,
                        principalTable: "CarlErpCurrencies",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CarlPayBillItemExchangeRates_CarlErpCurrencies_FromCurrency~",
                        column: x => x.FromCurrencyId,
                        principalTable: "CarlErpCurrencies",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_CarlPayBillItemExchangeRates_CarlErpPayBillDeail_PayBillIte~",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CarlPurchaseOrderExchangeRates_CarlErpCurrencies_FromCurren~",
                        column: x => x.FromCurrencyId,
                        principalTable: "CarlErpCurrencies",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_CarlPurchaseOrderExchangeRates_CarlErpPurchaseOrders_Purcha~",
                        column: x => x.PurchaseOrderId,
                        principalTable: "CarlErpPurchaseOrders",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_CarlPurchaseOrderExchangeRates_CarlErpCurrencies_ToCurrency~",
                        column: x => x.ToCurrencyId,
                        principalTable: "CarlErpCurrencies",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CarlReceivePaymentExchangeRates_CarlErpCurrencies_FromCurre~",
                        column: x => x.FromCurrencyId,
                        principalTable: "CarlErpCurrencies",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_CarlReceivePaymentExchangeRates_CarlErpReceivePayments_Rece~",
                        column: x => x.ReceivePaymentId,
                        principalTable: "CarlErpReceivePayments",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_CarlReceivePaymentExchangeRates_CarlErpCurrencies_ToCurrenc~",
                        column: x => x.ToCurrencyId,
                        principalTable: "CarlErpCurrencies",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CarlReceivePaymentItemExchangeRates_CarlErpCurrencies_FromC~",
                        column: x => x.FromCurrencyId,
                        principalTable: "CarlErpCurrencies",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_CarlReceivePaymentItemExchangeRates_CarlErpReceivePaymentDe~",
                        column: x => x.ReceivePaymentItemId,
                        principalTable: "CarlErpReceivePaymentDeails",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_CarlReceivePaymentItemExchangeRates_CarlErpCurrencies_ToCur~",
                        column: x => x.ToCurrencyId,
                        principalTable: "CarlErpCurrencies",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CarlVendorCreditExchangeRates_CarlErpCurrencies_FromCurrenc~",
                        column: x => x.FromCurrencyId,
                        principalTable: "CarlErpCurrencies",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_CarlVendorCreditExchangeRates_CarlErpVendorCredit_VendorCre~",
