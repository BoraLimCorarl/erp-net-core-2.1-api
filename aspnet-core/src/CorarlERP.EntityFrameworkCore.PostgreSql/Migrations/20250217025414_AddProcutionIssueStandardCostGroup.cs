        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CarlErpProductionIssueStandardCostGroups_CarlErpTransProduc~",
                        column: x => x.ProductionId,
                        principalTable: "CarlErpTransProductions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_CarlErpProductionIssueStandardCostGroups_CarlErpPropertyVal~",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CarlErpProductionIssueStandardCosts_CarlErpProductionPlans_~",
                        column: x => x.ProductionPlanId,
                        principalTable: "CarlErpProductionPlans",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_CarlErpProductionIssueStandardCosts_CarlErpPropertyValues_S~",
                        column: x => x.StandardCostGroupId,
                        principalTable: "CarlErpPropertyValues",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
