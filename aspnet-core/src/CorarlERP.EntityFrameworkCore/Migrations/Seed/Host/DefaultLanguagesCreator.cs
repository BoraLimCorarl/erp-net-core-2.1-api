...
namespace CorarlERP.Migrations.Seed.Host
{
    public class DefaultLanguagesCreator
    {
        ...
        {
            var tenantId = CorarlERPConsts.MultiTenancyEnabled ? null : (int?)1;
            return new List<ApplicationLanguage>
            {
                new ApplicationLanguage(tenantId, "en", "English", "famfamfam-flags us"),
                new ApplicationLanguage(tenantId, "km-KH", "Khmer (Cambodia)", "famfamfam-flags kh"),
        ...
        public DefaultLanguagesCreator(CorarlERPDbContext context)
        {
            _context = context;
        }
