...
{
    public class SubscriptionPaymentRepository : CorarlERPRepositoryBase<SubscriptionPayment, long>, ISubscriptionPaymentRepository
    {
        public SubscriptionPaymentRepository(IDbContextProvider<CorarlERPDbContext> dbContextProvider)
