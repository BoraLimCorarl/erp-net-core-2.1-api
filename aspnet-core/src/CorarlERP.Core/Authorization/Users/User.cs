...
namespace CorarlERP.Authorization.Users
{
    ...
    {
        public const string DefaultNoEmailDomain = "@noEmail.com";
        ...
        public static User CreateTenantAdminUser(int tenantId, string emailAddress, string userName, string firstName, string lastName)
        {
            var user = new User
            {
                TenantId = tenantId,
