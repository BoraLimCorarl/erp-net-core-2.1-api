    ...
    public class AppSettingProvider : SettingProvider
    {
        ...
        private IEnumerable<SettingDefinition> GetTenantSettings()
        {
            return new[]
            {
                ...
                new SettingDefinition(AppSettings.UserManagement.UseCaptchaOnLogin, GetFromAppSettings(AppSettings.UserManagement.UseCaptchaOnLogin, "true"), scopes: SettingScopes.Tenant, isVisibleToClients: true),
