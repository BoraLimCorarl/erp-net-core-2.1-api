...
namespace CorarlERP
{
    ...
    public class CorarlERPCoreModule : AbpModule
    {
        public override void PreInitialize()
        {
            ...
            CorarlERPLocalizationConfigurer.Configure(Configuration.Localization);
            ...
            Configuration.MultiTenancy.IsEnabled = CorarlERPConsts.MultiTenancyEnabled;
            ...
            Configuration.ReplaceService<IAuditInfoProvider, CustomAuditoProvider>(DependencyLifeStyle.Transient);

            Configuration.ReplaceService(typeof(IEmailSenderConfiguration), () =>
            {
                Configuration.IocManager.IocContainer.Register(
                    Component.For<IEmailSenderConfiguration, ISmtpEmailSenderConfiguration>()
                             .ImplementedBy<CorarlERPSmtpEmailSenderConfiguration>()
                             .LifestyleTransient()
                );
            });
            ...
            {
                cache.DefaultSlidingExpireTime = TimeSpan.FromMinutes(CorarlERPConsts.PaymentCacheDurationInMinutes);
            });
        }

        public override void Initialize()
        {
            IocManager.RegisterAssemblyByConvention(typeof(CorarlERPCoreModule).GetAssembly());
        }
