...
namespace CorarlERP.Authentication.TwoFactor.Google
{
    public class GoogleAuthenticatorProvider : CorarlERPServiceBase, IUserTwoFactorTokenProvider<User>, ITransientDependency
    {
