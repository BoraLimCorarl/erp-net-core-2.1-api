    ...
    public partial class BOMAndKitchenOrder : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_CarlErpKitchenOrderItemAndBOMItems_CarlErpKitchenOrderItems_KitchenOrderItemId",
                        column: x => x.KitchenOrderItemId,
                        principalTable: "CarlErpKitchenOrderItems",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_CarlErpKitchenOrderItemAndBOMItems_AbpUsers_LastModifierUserId",
                        column: x => x.LastModifierUserId,
                        principalTable: "AbpUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_CarlErpItemIssueItems_CarlErpKitchenOrderItemAndBOMItems_KitchenOrderItemAndBOMItemId",
                table: "CarlErpItemIssueItems",
                column: "KitchenOrderItemAndBOMItemId",
            ...
            migrationBuilder.Sql(@"INSERT INTO  CarlErpJournalTransactionTypes (Id,CreationTime ,CreatorUserId ,Name,IsIssue,IsDefault,Active,InventoryTransactionType,TenantId)
                                SELECT NEWID(),GETDATE(), t2.CreatorUserId, t1.IndxName, t1.IdxIssue, 1, 1, t1.Idx, t2.Id FROM(
                                 select 17 Idx, 'Kitchen Order' IndxName, 1 IdxIssue
                                ) as t1
            ...
            migrationBuilder.Sql(@"Insert Into CarlErpBOMs (Id,CreationTime,CreatorUserId,LastModificationTime,LastModifierUserId,TenantId,ItemId,IsDefault,Name,IsActive,Description,Qty)
                                    select NEWID(), item.CreationTime, item.CreatorUserId, item.LastModificationTime, item.LastModifierUserId, item.TenantId, item.Id, 1, 'Standard', item.IsActive, null, 1
            ...
            migrationBuilder.Sql(@"Insert Into CarlErpBOMItems(Id,CreationTime,CreatorUserId,LastModificationTime,LastModifierUserId,TenantId,ItemId,BomId,Qty)
                                    select NEWID(), item.CreationTime, item.CreatorUserId, item.LastModificationTime, item.LastModifierUserId, item.TenantId, item.ItemId, b.Id, item.Quantity
