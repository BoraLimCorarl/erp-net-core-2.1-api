        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_CarlErpLabTestRequests_CarlErpQCTestTemplates_QCTestTemplateId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CarlErpQCTestTemplateParameters_CarlErpQCTestTemplates_QCTestTemplateId",
                        column: x => x.QCTestTemplateId,
                        principalTable: "CarlErpQCTestTemplates",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_CarlErpLabTestResults_CarlErpLabTestRequests_LabTestRequestId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CarlErpLabTestResultDetails_CarlErpLabTestResults_LabTestResultId",
                        column: x => x.LabTestResultId,
                        principalTable: "CarlErpLabTestResults",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_CarlErpLabTestResultDetails_CarlErpTestParameters_TestParameterId",
            ...
            migrationBuilder.CreateIndex(
                ...
                unique: true,
                filter: "[ReferenceNo] IS NOT NULL AND [TenantId] IS NOT NULL AND [LabId] IS NOT NULL");
