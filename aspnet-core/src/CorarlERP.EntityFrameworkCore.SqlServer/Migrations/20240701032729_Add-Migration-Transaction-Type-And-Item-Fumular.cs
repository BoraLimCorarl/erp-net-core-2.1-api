        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CarlErpItemCodeFormulaItemTypes_CarlErpItemCodeFormulas_ItemCodeFormulaId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CarlErpItemCodeFormulaProperties_CarlErpItemCodeFormulas_ItemCodeFormulaId",
                        column: x => x.ItemCodeFormulaId,
                        principalTable: "CarlErpItemCodeFormulas",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_CarlErpItemCodeFormulaProperties_CarlErpProperties_PropertyId",
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_CarlErpJournals_CarlErpJournalTransactionTypes_JournalTransactionTypeId",
                table: "CarlErpJournals",
                column: "JournalTransactionTypeId",
            ...
            migrationBuilder.Sql(@"INSERT INTO  CarlErpJournalTransactionTypes(Id , CreationTime, CreatorUserId,LastModificationTime,LastModifierUserId,Name,IsIssue,IsDefault,Active,InventoryTransactionType,TenantId)
                                    SELECT NEWID(),GETDATE(),t2.CreatorUserId,NULL,NULL,t1.IndxName,t1.IdxIssue,1,1,t1.Idx,t2.Id  FROM  (
                                          select 1  Idx,'Purchase' IndxName, 0 IdxIssue
                                    union select 2  Idx, 'Sale Return' IndxName ,0 IdxIssue
                                    union select 3  Idx, 'Transfer' IndxName, 0 IdxIssue
                                    union select 4  Idx, 'Adjustment' IndxName, 0 IdxIssue
                                    union select 5  Idx, 'Other' IndxName, 0 IdxIssue
                                    union select 7  Idx, 'Sale' IndxName , 1 IdxIssue
                                    union select 8  Idx, 'Purchase Return' IndxName, 1 IdxIssue
                                    union select 9  Idx, 'Transfer' IndxName, 1 IdxIssue
                                    union select 10 Idx, 'Adjustment' IndxName, 1 IdxIssue
                                    union select 11 Idx, 'Other' IndxName, 1 IdxIssue
                                    union select 13 Idx, 'Physical Count' IndxName , 1 IdxIssue
                                    union select 14 Idx, 'Physical Count' IndxName , 0 IdxIssue
                                    union select 15 Idx, 'Production' IndxName , 0 IdxIssue
                                    union select 16 Idx, 'Production' IndxName, 1 IdxIssue
                                    ) t1
                                    full join AbpTenants t2
                                    on 1 = 1
            ...
            migrationBuilder.Sql(@"UPDATE CarlErpJournals
                                    ...
                                    union select 8  Idx, 'Purchanse Return' IndxName, 1 IdxIssue, 17 journalType 
                                    ...
                                    union select 16 Idx, 'Production' IndxName, 1 IdxIssue, 22 journalType 
                                     ...
                                     join CarlErpJournalTransactionTypes t2
            ...
            migrationBuilder.Sql(@"update AbpTenants set ItemCodeSetting = (case when AutoItemCode = 1 then 1 else 0 end)");
