...
namespace CorarlERP.Migrations
{
    public partial class AddTableReferral : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.Sql(@"UPDATE CarlErpSignUps SET Status = CASE WHEN CarlErpSubscriptions.IsTrail = 1 THEN 1 ELSE 2
                                   END FROM AbpTenants JOIN CarlErpSubscriptions ON CarlErpSubscriptions.Id = AbpTenants.SubscriptionId
