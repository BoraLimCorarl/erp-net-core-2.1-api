    ...
    public partial class UpdatePromotionCampaignAndSubscription : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.DropIndex(
                name: "IX_CarlErpPromotionCampaignEditions_PromotionCampaignId_EditionId_PromotionId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CarlErpSubscriptionCampaignPromotions_CarlErpPromotionCampaigns_CampaignId",
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_CarlErpSubscriptionCampaignPromotions_CarlErpPromotions_PromotionId",
                        column: x => x.PromotionId,
                        principalTable: "CarlErpPromotions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_CarlErpSubscriptionCampaignPromotions_CarlErpSubscriptionPromotions_SubscriptionPromotionId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CarlErpSubscriptionCampaignPromotions_SubscriptionPromotionId",
                table: "CarlErpSubscriptionCampaignPromotions",
                column: "SubscriptionPromotionId");

            migrationBuilder.AddForeignKey(
                name: "FK_CarlErpSubscriptionPromotions_CarlErpPromotionCampaigns_CampaignId",
                table: "CarlErpSubscriptionPromotions",
                column: "CampaignId",
                principalTable: "CarlErpPromotionCampaigns",
                principalColumn: "Id",
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_CarlErpPackageEditionPromotions_CarlErpPromotions_PromotionId",
                        column: x => x.PromotionId,
                        principalTable: "CarlErpPromotions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CarlErpPackageEditionPromotions_PackageId_EditionId_PromotionId",
                table: "CarlErpPackageEditionPromotions",
