...
{
    public partial class SignupSubscriptionPackage : Migration
    {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_CarlErpSubscriptionPromotions_CarlErpSubscriptions_SubscriptionId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_CarlErpPromotionCampaignEditions_CarlErpPromotionCampaigns_PromotionCampaignId",
                        column: x => x.PromotionCampaignId,
                        principalTable: "CarlErpPromotionCampaigns",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_CarlErpPromotionCampaignEditions_CarlErpPromotions_PromotionId",
                        column: x => x.PromotionId,
                        principalTable: "CarlErpPromotions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
