...
{
    public abstract class ProfileControllerBase : CorarlERPControllerBase
    {
        ...
        public UploadProfilePictureOutput UploadProfilePicture(FileDto input)
        {
            try
            {
                ...
                {
                    throw new UserFriendlyException(L("ProfilePicture_Warn_SizeLimit", CorarlERPConsts.MaxProfilPictureBytesUserFriendlyValue));
                }
