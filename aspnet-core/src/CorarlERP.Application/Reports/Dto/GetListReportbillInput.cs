...
{
   public class GetListReportBillInput : PagedSortedAndFilteredInputDto, IShouldNormalize
    {
    ...
    public class GetBillReportInput : GetListReportBillInput
    {
        public ReportOutput ReportOutput { get; set; }
    }
    public class GetListBillReportGroupByOutput
    {
        public string KeyName { get; set; }
        public List<GetListReportBillOutput> Items { get; set; }
    }
