...
{
   public class GetListReportSaleOrderByItemPropertyInput : PagedSortedAndFilteredInputDto
    {
    ...
    public class GetSaleOrderByItemPropertyReportInput : GetListReportSaleOrderByItemPropertyInput
    {
