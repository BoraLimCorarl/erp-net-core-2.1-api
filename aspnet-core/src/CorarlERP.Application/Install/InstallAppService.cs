...
using CorarlERP.Migrations.Seed.Host;
...
namespace CorarlERP.Install
{
    [AbpAllowAnonymous]
    [DisableAuditing]
    public class InstallAppService : CorarlERPAppServiceBase, IInstallAppService
    {
        private readonly AbpZeroDbMigrator<CorarlERPDbContext> _migrator;
        ...
        private string GetConnectionString()
        {
            ...
            return connectionStrings.Property(CorarlERPConsts.ConnectionStringName).Value.ToString();
        }
