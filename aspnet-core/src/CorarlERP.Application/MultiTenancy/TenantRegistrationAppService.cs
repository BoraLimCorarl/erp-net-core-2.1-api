...
using CorarlERP.MultiTenancy.Payments.Cache;
...
{
    public class TenantRegistrationAppService : CorarlERPAppServiceBase, ITenantRegistrationAppService
    {
