...
using CorarlERP.Timing.Dto;
using TimeZoneConverter;

namespace CorarlERP.Timing
{
    public class TimingAppService : CorarlERPAppServiceBase, ITimingAppService
    {
        ...
        public TestTimeOutput TestTime(TestTimeInput input)
        {
            return new TestTimeOutput
            {
                DateTime = input.DateTime.ToString("yyyy-MM-dd HH:mm:ss tt"),
                ConvertedDateTime = input.ConvertedDateTime.ToString("yyyy-MM-dd HH:mm:ss tt")
            };
        }
