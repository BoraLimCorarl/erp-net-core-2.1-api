...
using CorarlERP.DemoUiComponents.Dto;

namespace CorarlERP.DemoUiComponents
{
    [AbpAuthorize(AppPermissions.Pages_DemoUiComponents)]
    public class DemoUiComponentsAppService : CorarlERPAppServiceBase, IDemoUiComponentsAppService
    {
