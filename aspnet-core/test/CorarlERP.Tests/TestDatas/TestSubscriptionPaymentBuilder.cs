...
namespace CorarlERP.Tests.TestDatas
{
    ...
    public class TestSubscriptionPaymentBuilder
    {
        ...
        public TestSubscriptionPaymentBuilder(CorarlERPDbContext context, int tenantId)
        {
            _context = context;
            _tenantId = tenantId;
        }
        ...
        {
            var defaultEdition = _context.Editions.FirstOrDefault(e => e.Name == EditionManager.AdvanceEditName);
